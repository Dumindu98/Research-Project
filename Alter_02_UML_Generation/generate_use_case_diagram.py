...
OUTPUTS_GENERATED_USECASE_DIAGRAMS_FOLDER = os.path.join(APP_ROOT, 'outputs', 'generated_use_case_diagrams')
...
def generate_use_case_diagram(actors,extracted_relationships,actors_and_use_cases_array):
    ...
    dot_file = open(OUTPUTS_GENERATED_DOT_FILES_FOLDER + "/use_cases_" + dot_file_name + ".dot", "x")
...
def generate_diagram(filename):
    subprocess.run(["dot", "-Tpng", OUTPUTS_GENERATED_DOT_FILES_FOLDER+"/use_cases_"+filename+".dot", "-o", OUTPUTS_GENERATED_USECASE_DIAGRAMS_FOLDER+"/"+filename+".png"])
    return True
