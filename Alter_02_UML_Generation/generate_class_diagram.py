...
OUTPUTS_GENERATED_CLASS_FILES_FOLDER = os.path.join(APP_ROOT, 'outputs', 'generated_class_files')
OUTPUTS_GENERATED_DOT_FILES_FOLDER = os.path.join(APP_ROOT, 'outputs', 'generated_dot_files')
OUTPUTS_GENERATED_CLASS_DIAGRAMS_FOLDER = os.path.join(APP_ROOT, 'outputs', 'generated_class_diagrams')
...
def generate_diagram(filename):
    subprocess.run(["pyreverse", "-S", "-o", "dot", "-p", filename, OUTPUTS_GENERATED_CLASS_FILES_FOLDER+"/"+filename+".py"])
    shutil.move("classes_"+filename+".dot",OUTPUTS_GENERATED_DOT_FILES_FOLDER)
    subprocess.run(["dot", "-Tpng", OUTPUTS_GENERATED_DOT_FILES_FOLDER+"/classes_"+filename+".dot", "-o", OUTPUTS_GENERATED_CLASS_DIAGRAMS_FOLDER+"/"+filename+".png"])
...
def generate_class(actors,data):
    ...
    class_file = open(OUTPUTS_GENERATED_CLASS_FILES_FOLDER+"/"+python_class_file_name+".py","x")
